...
# ──────────────────────────────────────────────────────────────────────────────
# CONFIG — tune these after running calibration
# ──────────────────────────────────────────────────────────────────────────────
...
START_OFFSET_SEC = (1 * 3600) + (35 * 60)  # 1h34m — set to 0 to start from beginning
...
if __name__ == "__main__":
    run(
        ...
        video_path="/home/dior/Projects/Uniform1/videos/cam2_016.mp4",
        samples="/home/dior/Projects/Uniform1/samples/",
    )